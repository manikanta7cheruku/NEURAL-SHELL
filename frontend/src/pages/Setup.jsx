...
const LABELS = ['Welcome', 'Identity', 'Personalize', 'Environment', 'Model', 'Launch'];
    ...
    <div className="h-screen w-screen bg-s-bg flex flex-col">
      ...
      <div className="flex-shrink-0">
        ...
        <div className="w-full h-[1px] bg-s-border">
          <div
            className="h-full bg-gradient-to-r from-s-accent to-s-accent-h
          ...
          {LABELS.map((label, i) => {
            ...
            return (
              <div key={label} className="flex items-center gap-1.5">
                ...
                {i < LABELS.length - 1 && (
                  <div className={`w-6 h-[1px] ml-1.5 transition-colors duration-300
